...
in {
  ...
  programs.helix = {
    ...
    languages = with pkgs; {
      language-server = {
        ...
        docker-compose-language-service = {
          command =
            "${docker-compose-language-service}/bin/docker-compose-langserver";
          args = [ "--stdio" ];
        };
        yaml-language-server = {
      ...
      language = [
        ...
        }
        {
          name = "docker-compose";
          language-servers =
            [ "docker-compose-language-service" "yaml-language-server" ];
        }
        {
          name = "json";
  ...
  xdg.configFile."helix/themes/kinda_nvim.toml".source =
    "${inputs.kinda-nvim-hx}/kinda_nvim.toml";
