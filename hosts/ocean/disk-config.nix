{
  ...
  disko.devices = {
    disk.disk1 = {
      type = "disk";
      device = "/dev/disk/by-id/nvme-Samsung_SSD_990_PRO_2TB_S73WNJ0W935536A";
      content = {
        type = "gpt";
        partitions = {
          esp = {
    ...
    zpool = {
      rpool = {
        ...
        datasets = {
          ...
          "crypt/system/var/lib/rancher/k3s/server" = {
            type = "zfs_fs";
            mountpoint = "/var/lib/rancher/k3s/server";
            options = {
              "com.sun:auto-snapshot" = "false";
            };
          };
          "crypt/system/var/lib/rancher/k3s/agent" = {
            type = "zfs_fs";
